  ...
  return (
    <Stack className="intro-section" direction="row">
      <Stack className="intro-content">
        <Stack className="intro-text">
          ...
          <Typography className="intro-desc">
            MONOLITH is a premier destination for individuals seeking a
            harmonious blend of modern aesthetics and timeless sophistication in
            their home.
          </Typography>
        </Stack>
      ...
      <Box className="intro-image">
        <img src="/img/homepage/homee1.jpg" alt="MONOLITH Furniture" />
      </Box>
    </Stack>
  );
};
