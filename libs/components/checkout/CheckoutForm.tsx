			...
			<Stack className="billing-section">
				...
				<Stack className="form-fields">
					...
					<label className="checkbox-row">
						...
						/>
						<span className="checkbox-label">My billing and shipping address are the same</span>
					</label>
				</Stack>
			</Stack>
				...
				<Stack className="payment-fields">
					...
					>
						<div className="payment-option-left">
							<span className={`radio-btn ${paymentMethod === 'card' ? 'radio-selected' : ''}`} />
							<span className="payment-option-label">Credit / Debit / ATM Card</span>
						</div>
						<img src="/img/payment/visa.svg" alt="Visa" className="payment-logo" />
					</div>
					...
					>
						<div className="payment-option-left">
							<span className={`radio-btn ${paymentMethod === 'paypal' ? 'radio-selected' : ''}`} />
							<span className="payment-option-label">Paypal</span>
						</div>
						<img src="/img/payment/paypal.svg" alt="PayPal" className="payment-logo" />
					</div>
					...
					>
						<div className="payment-option-left">
							<span className={`radio-btn ${paymentMethod === 'cod' ? 'radio-selected' : ''}`} />
					...
					<label className="checkbox-row">
						...
						/>
						<span className="checkbox-label">Save card details for future payment method.</span>
					</label>
