      ...
      <Box className="add-furniture-steps">
        {[1, 2, 3].map((s) => (
          <React.Fragment key={s}>
            <Box
              className={`af-step ${step >= s ? "active" : ""} ${step > s ? "done" : ""}`}
            >
          ...
          <>
            ...
            <div className="add-furniture-grid">
              <Box className="add-furniture-field">
                <label className="add-furniture-label">
                  Title {REQUIRED_MARK}
                </label>
                <TextField
                  fullWidth
                ...
                <Box className="add-furniture-field">
                  ...
                  <FormControl fullWidth>
                    <Select
                      ...
                      onChange={(e) =>
                        set("assemblyDifficulty", e.target.value)
                      }
                      className="add-furniture-select"
                      displayEmpty
                    >
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={(e) =>
                        set("furnitureBestseller", e.target.checked)
                      }
                    />
                  }
                  label="Bestseller"
