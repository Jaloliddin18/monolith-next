	...
	return (
		<Stack className="article-content-section">
			...
			<div className="article-author-row">
				<img className="article-author-avatar" src={authorImage} alt={authorName} />
			...
			<div className="article-stats-row">
				<span className="article-stat">
					<VisibilityOutlinedIcon sx={{ fontSize: 17 }} /> {article.articleViews} views
				</span>
				<span className="article-stat">
					<ChatBubbleOutlineIcon sx={{ fontSize: 17 }} /> {article.articleComments} comments
				</span>
				<button
					type="button"
